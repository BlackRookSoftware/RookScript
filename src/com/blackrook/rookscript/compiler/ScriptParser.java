...
public class ScriptParser extends Parser
{
	...
	// Operator reduce.
	private boolean operatorReduce(Script currentScript, Stack<Integer> operatorStack, int[] expressionValueCounter, int nextOperator) 
	{
	...
	private boolean expressionReduce(Script currentScript, Stack<Integer> operatorStack, int[] expressionValueCounter)
	{
	...
	private boolean expressionReduceAll(Script currentScript, Stack<Integer> operatorStack, int[] expressionValueCounter)
	{
