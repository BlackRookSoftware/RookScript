...
Black Rook Expressions Library
...
common.io.lib
	The location of the Black Rook Common I/O Library binaries (for build 
	classpath).
	Default: "${dev.base}/CommonIo/bin"
common.lang.lib
	The location of the Black Rook Common Lang Library binaries (for build 
	classpath).
